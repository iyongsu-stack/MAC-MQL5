...
input double              MultiFactorL1  = 1.5;         // StdMultiFactorL1
input double              MultiFactorL2  = 3.0;         // StdMultiFactorL2
input double              MultiFactorL3  = 1.5;         // StdMultiFactorL3


double SellPressure[], BuyPressure[],
       LWMAVal[],
       SumSellPressure[], SumBuyPressure[], SumDiffPressure[],
       valLR[], valLRC[], avgValLR[],
...
void OnInit()
  {
   ...
   SetIndexBuffer(8,avgValLR,INDICATOR_DATA);  
   ...
   string short_name = "BSPLR2STDV2("+ (string)LwmaPeriod + ", " + (string)LRPeriod + ", " + 
                                            (string)StdPeriodL + ",, " + 
