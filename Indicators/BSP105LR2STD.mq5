...
input int                 StdPeriodL    = 2880;        // StdPeriodL
...
input double              MultiFactorL3  = 0.8;         // StdMultiFactorL3

input double              MultiFactorS1  = 0.8;        // StdMultiFactorS1
input double              MultiFactorS2  = 2.0;         // StdMultiFactorS2
input double              MultiFactorS3  = 0.8;         // StdMultiFactorS3
