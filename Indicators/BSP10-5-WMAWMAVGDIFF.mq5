...
void OnInit()
  {
   ...
   SetIndexBuffer(1,WmaSumDiffPressure,INDICATOR_CALCULATIONS);
   ...
   string short_name = "BSPWMAWMAVGDIFFREL("+ (string)WmaPeriod +", "+ (string)WmaPeriod2 + ")";      
