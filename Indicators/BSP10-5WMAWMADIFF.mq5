...
double SellPressure[], BuyPressure[],
       ...
       SumSellPressure[], SumBuyPressure[], SumDiffPressure[], WmaSumDiffPressure[], DiffPressure[];
...
void OnInit()
  {
   ...
   string short_name = "BSPWMAWMA("+ (string)WmaPeriod +", "+ (string)WmaPeriod2 + ")";      
