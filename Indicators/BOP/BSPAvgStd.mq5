...
double  BOP[], BOPAvg[], Diff[], DiffC[], Up3[], Up2[], Up1[], Down1[], Down2[], Down3[];
...
void OnInit()
  {
   ...
   if(stdDev3 != NULL) delete stdDev3;
   ...
   //---
   IndicatorSetString(INDICATOR_SHORTNAME,"BOPAvgStd ("+(string)inpSmoothPeriod+", "+
