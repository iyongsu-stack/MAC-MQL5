...
/*
   ...
   SetIndexBuffer(3,AvgBuyPressure,INDICATOR_DATA);
   SetIndexBuffer(4,AvgSellPressure,INDICATOR_DATA);
...
double alpha1 = 2.0 / (1.0+MathSqrt(EMA2Period));
  ...
  for(int bar=third; bar<rates_total; bar++)
     {
       ...
       AvgBuyPressure2[bar]= Average(bar, AvgPeriod2, AvgBuyPressure);
       AvgSellPressure2[bar]= Average(bar, AvgPeriod2, AvgSellPressure);
