...
void OnInit()
  {
   ...
   string str="";
   StringConcatenate(str,AvgPeriod,",",EmaPeriod);
   IndicatorSetString(INDICATOR_SHORTNAME,"("+str+")");


   SetIndexBuffer(0,BSPDiff,INDICATOR_DATA);   
   SetIndexBuffer(1,dema_BuyPressure,INDICATOR_CALCULATIONS);   
   SetIndexBuffer(2,dema_SellPressure,INDICATOR_CALCULATIONS);  
   SetIndexBuffer(3,dema_TotalPressure,INDICATOR_CALCULATIONS);      
   SetIndexBuffer(4,ema_BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(5,ema_SellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(6,wma_TotalPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(7,avg_BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(8,avg_SellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(9,SellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(10,BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(11,TotalPressure,INDICATOR_CALCULATIONS);
