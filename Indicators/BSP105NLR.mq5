...
input int                 NLRPeriod    = 12;          // NLRPeriod
...
void OnInit()
  {
   ...
   string short_name = "BSPWMAWMAABS("+ (string)NLRPeriod +", "+ (string)WmaPeriod2 + ")";      
   ...
   for(int bar=second; bar<rates_total; bar++)
     {
       ...
       avg1BuyPressure[bar] = iNlr(BuyPressure[bar], NLRPeriod, bar, 0, rates_total);
       avg1SellPressure[bar] = iNlr(SellPressure[bar], NLRPeriod, bar, 0, rates_total);
