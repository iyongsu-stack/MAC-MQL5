...
input double             stdMultiFactor = 0.2;        // StdMultiFactor
...
void OnInit()
  {
   ...
   string short_name = "LWMAPRESTD("+ (string)inpPeriod + ", " + (string)stdPeriod + ", " + (string)stdMultiFactor + ")";      
