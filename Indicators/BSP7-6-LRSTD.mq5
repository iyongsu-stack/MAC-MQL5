...
input double              StdMultiFactor = 1.5;     //Std Multi-Factor 
...
double BSPDiff[], LR_BSPDiff[], Avg_LR_BSPDiff[],
       Up_Avg_LR_BSPDiff[], Down_Avg_LR_BSPDiff[],
...
void OnInit()
  {
   ...
   SetIndexBuffer(1,Avg_LR_BSPDiff,INDICATOR_DATA); 
   SetIndexBuffer(2,Up_Avg_LR_BSPDiff,INDICATOR_DATA); 
   SetIndexBuffer(3,Down_Avg_LR_BSPDiff,INDICATOR_DATA);      
   SetIndexBuffer(4,BSPDiff,INDICATOR_CALCULATIONS);   
   SetIndexBuffer(5,tema_BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(6,tema_SellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(7,AvgBuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(8,AvgSellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(9,BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(10,SellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(11,mVolume,INDICATOR_CALCULATIONS);
   SetIndexBuffer(12,ema_BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(13,ema_SellPressure,INDICATOR_CALCULATIONS);
...
int OnCalculate(const int rates_total,    // number of bars in history at the current tick
                ...
                const int &spread[])
  {
   ...
   double dema_BuyPressure, dema_SellPressure, standardDeviation;
...
//---- The main loop of the indicator calculation
  ...
  for(int bar=fifth; bar<rates_total; bar++)
     {        
       Avg_LR_BSPDiff[bar]= Average(bar, StdPeriod, LR_BSPDiff);
     }       
  ...
  for(int bar=sixth; bar<rates_total; bar++)
     {        
       standardDeviation = StdDev(bar, StdPeriod, Avg_LR_BSPDiff, LR_BSPDiff);
       Up_Avg_LR_BSPDiff[bar] = Avg_LR_BSPDiff[bar] + standardDeviation * StdMultiFactor;
       Down_Avg_LR_BSPDiff[bar] = Avg_LR_BSPDiff[bar] - standardDeviation * StdMultiFactor;
     }       
