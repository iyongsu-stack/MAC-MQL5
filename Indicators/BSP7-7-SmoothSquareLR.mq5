...
input int                 SLRPeriod      = 2;         //SLR Period 
...
double SellPressure[], BuyPressure[], mVolume[], 
       ...
       ema_BuyPressure[], ema_SellPressure[], SLR_AvgBSPDiff[];
...
void OnInit()
  {
   ...
   SetIndexBuffer(0,SLR_AvgBSPDiff,INDICATOR_DATA);   
   SetIndexBuffer(1,LR_AvgBSPDiff,INDICATOR_CALCULATIONS);   
   SetIndexBuffer(2,BSPDiff,INDICATOR_CALCULATIONS);   
   SetIndexBuffer(3,tema_BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(4,tema_SellPressure,INDICATOR_CALCULATIONS);
   ...
   SetIndexBuffer(10,ema_BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(11,ema_SellPressure,INDICATOR_CALCULATIONS);
...
//---- The main loop of the indicator calculation
  ...
  for(int bar=fifth; bar<rates_total; bar++)
     {        
       SLR_AvgBSPDiff[bar]= LinearRegression(bar,SLRPeriod, LR_AvgBSPDiff);
     }       
