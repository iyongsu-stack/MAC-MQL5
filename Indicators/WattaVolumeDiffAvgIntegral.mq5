//+------------------------------------------------------------------+
//|                                   WattaVolumeDiffAvgIntegral.mq5 |
//|                                                     Yong-su, Kim |
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
...
void OnInit()
  {
   SetIndexBuffer(0,p3SumBuffer,INDICATOR_DATA);
   SetIndexBuffer(1,p1Buffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(2,p2Buffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(3,p3Buffer,INDICATOR_CALCULATIONS);

   string shortname="BuySellPowerDiffIntegral";
//   StringConcatenate(shortname,"BuySellPowerDiffIntegral');
