...
//   SetIndexBuffer(2,p3BufferLR,INDICATOR_DATA);
   ...
   SetIndexBuffer(1,p1AvgBuffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(2,p2AvgBuffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(3,p3AvgBuffer,INDICATOR_CALCULATIONS);
   ...
   string shortname;
   StringConcatenate(shortname,"BuySellPowerRatio(",AveragePeriod,")");
