...
//   SetIndexBuffer(2,p3BufferLR,INDICATOR_DATA);
   SetIndexBuffer(0,p3AvgBuffer,INDICATOR_DATA);
   ...
   string shortname;
   StringConcatenate(shortname,"BuySellPowerDiffLR(",LRPeriod,")");
      ...
      for(int i = smallCurBar; i > smallNextBar; i--)
        {
           ...
           double highest_m1aa = iHigh(NULL, PERIOD_M1, iHighest(NULL, PERIOD_M1, MODE_HIGH, 2, i));
           double lowest_m1aa  = iLow(NULL, PERIOD_M1, iLowest(NULL, PERIOD_M1, MODE_LOW, 2, i)); 
           P1 = mVolume*(iClose(NULL,PERIOD_M1,0)-lowest_m1aa )/(highest_m1aa-lowest_m1aa);
...
//        p2BufferLR[LRbar]= -LinearRegression(LRbar, LRPeriod,  p2Buffer);
          p3AvgBuffer[LRbar] = LinearRegression(LRbar, LRPeriod, p3Buffer);
