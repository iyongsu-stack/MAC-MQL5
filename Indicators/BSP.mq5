...
input int                 AvgPeriod2     = 45;            //2'nd Avg Period
input int                 StdPeriod      = 1440;          //Std Period 
input double              StdMultiFactor = 1.0;           //Std Multi FActor                
input double              ThreshHold     = 0.;            //ThreshHold
input uint                XLength1       = 2;             // Depth of the first smoothing
input uint                XLength2       = 2;             // Depth of the second smoothing
...
void OnInit()
  {
   ...
   SetIndexBuffer(1,Up_AvgBSPDiff,INDICATOR_DATA);  
   SetIndexBuffer(2,Down_AvgBSPDiff,INDICATOR_DATA);      
   SetIndexBuffer(3,AvgBSPDiff,INDICATOR_DATA);   
   ...
   SetIndexBuffer(12,std_AvgBSPDiff,INDICATOR_CALCULATIONS);
...
int OnCalculate(const int rates_total,    // number of bars in history at the current tick
                ...
                const int &spread[])
  {
   ...
   double standardDeviation, dema_BuyPressure, dema_SellPressure, mVolume;
