...
input int                 WmaPeriod2   = 120;          // WmaPeriod2
input int                 LRPeriod     = 6;          //LRPeriod
...
double SellPressure[], BuyPressure[],
       ...
       DiffPressure[], LRDiffPressure[];


//+------------------------------------------------------------------+  
void OnInit()
  {
   SetIndexBuffer(0,LRDiffPressure,INDICATOR_DATA);
   SetIndexBuffer(1,DiffPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(2,WmaSumDiffPressure,INDICATOR_CALCULATIONS);
   ...
   string short_name = "BSPWMAWMAVGDIFFLRREL("+ (string)WmaPeriod +", "+ (string)WmaPeriod2 + ")";      
