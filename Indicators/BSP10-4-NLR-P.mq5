...
input int                 NLRPeriod     = 25;          // NLR Period
...
double SellPressure[], BuyPressure[], TotalPressure[],
       ...
       avg2SellPressure[], avg2BuyPressure[], avg2TotalPressure[],
       avg3SellPressure[], avg3BuyPressure[], avg3TotalPressure[],     
       SumDiffPressure[],
       val[], valc[];
...
void OnInit()
  {
   ...
   SetIndexBuffer(5,avg1TotalPressure,INDICATOR_CALCULATIONS);

   SetIndexBuffer(6,avg2BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(7,avg2SellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(8,avg2TotalPressure,INDICATOR_CALCULATIONS);

   SetIndexBuffer(9,avg3BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(10,avg3SellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(11,avg3TotalPressure,INDICATOR_CALCULATIONS);

   SetIndexBuffer(12,BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(13,SellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(14,TotalPressure,INDICATOR_CALCULATIONS);
   ...
   for(int bar=third; bar<rates_total; bar++)
     {
       ...
       avg2TotalPressure[bar] = iWma(bar, WmaPeriod2, avg1TotalPressure);
     ...
     for(int bar=fourth; bar<rates_total; bar++)
     {
       ...
       avg3TotalPressure[bar] = iWma(bar, WmaPeriod3, avg2TotalPressure);
       double DiffPressure = (avg3BuyPressure[bar]-avg3SellPressure[bar])/avg3TotalPressure[bar];
...
/*      
       ...
       {
         SumDiffPressure[bar] = DiffPressure;
       }
            
       else
       {
         SumDiffPressure[bar] = SumDiffPressure[bar-1] + DiffPressure;
       }
*/      
       SumDiffPressure[bar] = SumDiffPressure[bar-1] + DiffPressure;
