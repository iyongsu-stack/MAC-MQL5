...
input int                 LRPeriod      = 20;           //LR period


//---- declaration of dynamic arrays that
//---- will be used as indicator buffers
double p1Buffer[], p2Buffer[], p3Buffer[], /*, p1BufferLR[], p2BufferLR[], p3BufferLR[]*/
       p1AvgBuffer[], p2AvgBuffer[], p3AvgBuffer[], p1AvgBufferLR[], p2AvgBufferLR[];
...
//   SetIndexBuffer(2,p3BufferLR,INDICATOR_DATA);
   SetIndexBuffer(0,p1AvgBufferLR,INDICATOR_DATA);
   SetIndexBuffer(1,p2AvgBufferLR,INDICATOR_DATA);
   ...
   SetIndexBuffer(5,p1Buffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(6,p2Buffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(7,p3Buffer,INDICATOR_CALCULATIONS);
   
//   ArrayInitialize(p1BufferLR, 0.);
//   ArrayInitialize(p2BufferLR, 0.);
//   ArrayInitialize(p3BufferLR, 0.);
   ArrayInitialize(p1AvgBufferLR, 0.);
   ArrayInitialize(p2AvgBufferLR, 0.);
   ...
   for(int LRbar=second; LRbar<rates_total; LRbar++)
     {
        ...
        p1AvgBufferLR[LRbar]= LinearRegression(LRbar, LRPeriod, p1AvgBuffer); 
        p2AvgBufferLR[LRbar]= -LinearRegression(LRbar, LRPeriod,  p2AvgBuffer);
