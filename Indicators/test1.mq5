...
input int                 WmaPeriod    = 20;          // WmaPeriod1
input int                 LRPeriod     = 5;           // LRPeriod
input int                 AvgPeriod    = 100;          // AvgPeriod
input int                 StdPeriod    = 1440;        // StdPeriod
input double              MultiFactor  = 1.0;         // StdMultiFactor
...
double SellPressure[], BuyPressure[], TotalPressure[],
       avg1SellPressure[], avg1BuyPressure[], avg1TotalPressure[],
       avgBuyRatio[], avgSellRatio[],
       SumSellPressure[], SumBuyPressure[], SumDiffPressure[],
       val[], valLR[], avgValLR[], stdAvgValLR[], upStdAvgValLR[], downStdAvgValLR[];
   ...
   for(int bar=second; bar<rates_total; bar++)
     {
       ...
       avg1TotalPressure[bar] = iWma(bar, WmaPeriod, TotalPressure);

       if(avg1TotalPressure[bar]==0.) avg1TotalPressure[bar] = 0.0000001;
       avgBuyRatio[bar] = avg1BuyPressure[bar]/avg1TotalPressure[bar];
       avgSellRatio[bar] = avg1SellPressure[bar]/avg1TotalPressure[bar];
...
*/
       ...
       SumBuyPressure[bar] = SumBuyPressure[bar-1] + avgBuyRatio[bar];
       SumSellPressure[bar] = SumSellPressure[bar-1] + avgSellRatio[bar];
