//+------------------------------------------------------------------+
//|                                  BSP10-4-NLR-PercentPressure.mq5 |
//|                                                     Yong-su, Kim |
...
void OnInit()
  {
   ...
   SetIndexBuffer(0,avgPressure,INDICATOR_DATA);
   SetIndexBuffer(1,Pressure,INDICATOR_CALCULATIONS);
   ...
   SetIndexBuffer(7,avg1BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(8,avg1SellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(9,avg2BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(10,avg2SellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(11,avg3BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(12,avg3SellPressure,INDICATOR_CALCULATIONS);
   ...
   for(int bar=fifth; bar<rates_total; bar++)
     {
      ...
      {
         Pressure[bar] = BuyPressure[bar] - SellPressure[bar];
         TotalPressure[bar] = BuyPressure[bar] + SellPressure[bar];
         NumBar = 1;
         avgPressure[bar] = Pressure[bar]/TotalPressure[bar];
      }   
      else 
      {
         NumBar++;
         Pressure[bar] = Pressure[bar-1] + (BuyPressure[bar] - SellPressure[bar]);
         TotalPressure[bar] = TotalPressure[bar-1] + (BuyPressure[bar] + SellPressure[bar]);
         avgPressure[bar] = Pressure[bar]/TotalPressure[bar];
      }     
