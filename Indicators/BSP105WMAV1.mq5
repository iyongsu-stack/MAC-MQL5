...
double SellPressure[], BuyPressure[],
       ...
       SumSellPressure[], SumBuyPressure[], SumDiffPressure[], WmaSumDiffPressure[], WmaSumDiffPressureC[];
...
void OnInit()
  {
   ...
   SetIndexBuffer(1,WmaSumDiffPressureC,INDICATOR_COLOR_INDEX);   
   ...
   for(int bar=third; bar<rates_total; bar++)
     {
       ...
       WmaSumDiffPressureC[bar] = (bar>0) ? (WmaSumDiffPressure[bar]>WmaSumDiffPressure[bar-1]) ? 0 : 
                                          (WmaSumDiffPressure[bar]<WmaSumDiffPressure[bar-1]) ? 1 : WmaSumDiffPressure[bar-1] : 0;
