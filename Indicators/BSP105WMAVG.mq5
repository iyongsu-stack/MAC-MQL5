...
input int                 WmaPeriod2   = 20;          // WmaPeriod2
...
//   SetIndexBuffer(2,SumDiffPressureC,INDICATOR_COLOR_INDEX);   
   ...
   SetIndexBuffer(2,SumBuyPressure,INDICATOR_DATA);
   SetIndexBuffer(3,SumSellPressure,INDICATOR_DATA);
   SetIndexBuffer(4,avg1Volume,INDICATOR_CALCULATIONS);
   SetIndexBuffer(5,avg1BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(6,avg1SellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(7,Volume,INDICATOR_CALCULATIONS);
   SetIndexBuffer(8,BuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(9,SellPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(10,nfBuyPressure,INDICATOR_CALCULATIONS);
   SetIndexBuffer(11,nfSellPressure,INDICATOR_CALCULATIONS);
