...
void OnInit()
  {
   ...
   string short_name = "BSPNLRSTD("+ (string)LwmaPeriod + ", " + (string)LRPeriod + ", " + (string)AvgPeriod + ", " + (string)StdPeriod + ", " + (string)MultiFactor +")";      
   ...
   for(int bar=first; bar<rates_total; bar++)
     {
       ...
       BuyPressure[bar] = (tempBuyRatio);
       SellPressure[bar] = (tempSellRatio); 
