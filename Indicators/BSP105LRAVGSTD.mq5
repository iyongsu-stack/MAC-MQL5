...
input int                 LwmaPeriod    = 3;          // WmaPeriod1
input int                 AvgPeriod    = 15;          //AvgPeriod
input int                 StdPeriodL    = 5000;        // StdPeriodL
input int                 StdPeriodS    = 10;        // StdPeriodS

input double              MultiFactorL1  = 1.5;         // StdMultiFactorL1
input double              MultiFactorL2  = 2.5;         // StdMultiFactorL2
input double              MultiFactorL3  = 5.0;         // StdMultiFactorL3
...
void OnInit()
  {
   ...
   SetIndexBuffer(2,up3StdAvgValLR,INDICATOR_DATA); 
   SetIndexBuffer(3,stdS,INDICATOR_DATA);     
   SetIndexBuffer(4,stdSC,INDICATOR_COLOR_INDEX);     
...
//---- The main loop of the indicator calculation
  ...
  for(int bar=fifth; bar<rates_total; bar++)
     {        
      stdS[bar] = StdDev(bar, StdPeriodS, avgValLR, LWMAVal);  
