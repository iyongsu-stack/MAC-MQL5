...
//--- indicator buffers mapping
   SetIndexBuffer(0,AverageBuffer1,INDICATOR_DATA);
   SetIndexBuffer(1,AverageBuffer2,INDICATOR_DATA);
...
//--- the main loop of calculations
   ...
   for(int avgbar=first; avgbar<rates_total; avgbar++)
     { 
        AverageBuffer1[avgbar]= Average(avgbar, AvgPeriod1, ExtBullsBearsBuffer)*MultiFactor;                 
     }  
   ...
   for(int avgbar=second; avgbar<rates_total; avgbar++)
     { 
        AverageBuffer2[avgbar]= Average(avgbar, AvgPeriod2, ExtBullsBearsBuffer)*MultiFactor; 
     }  
