...
//--- input params
input int            InpChPeriod1 = 540;           //Long Period
input int            InpChPeriod2 = 10;           //Long Period


int ExChPeriod;
//---- buffers
double rlBuffer[],sqareBuffer[]; 
...
//--- check input variables
   ...
   SetIndexBuffer(0,sqareBuffer,INDICATOR_DATA);
   ...
   for(bar=second; bar<rates_total; bar++)
     {
        ...
        sqareBuffer[bar]= LinearRegression(bar,InpChPeriod2, rlBuffer); 
