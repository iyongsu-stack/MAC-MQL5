...
input uint           XLength3     =2;            //Depth of the third averaging                   
...
int ExChPeriod;
//---- buffers
double rlBuffer[],squareBuffer[], temp1_squarBuffer[], temp2_squareBuffer[], temp3_squareBuffer[]; 
...
//--- check input variables
   ...
   SetIndexBuffer(0,squareBuffer,INDICATOR_DATA);
   SetIndexBuffer(1,rlBuffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(2,temp1_squarBuffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(3,temp2_squareBuffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(4,temp3_squareBuffer,INDICATOR_CALCULATIONS);
...
// Second Linear Regression    
   ...
   for(bar=second; bar<rates_total; bar++)
     { 
        ...
        temp3_squareBuffer[bar]=XMA2.XMASeries(second,prev_calculated,rates_total,(int)MODE_EMA,XPhase,XLength2,temp2_squareBuffer[bar],bar,false);
        squareBuffer[bar]=XMA3.XMASeries(second,prev_calculated,rates_total,(int)MODE_EMA,XPhase,XLength3,temp3_squareBuffer[bar],bar,false);                
