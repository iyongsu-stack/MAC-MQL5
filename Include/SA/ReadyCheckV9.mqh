...
bool OpenReadyCheck(int m_Session)
{
   ...
   if( SessionMan.CanGoBand && !OpenReady[m_Session].SellLASMReady && (LASMBand>=SellOpenReadyBand) ) 
     {
...
//  Buy Open Ready Check      
   if( SessionMan.CanGoBand && !OpenReady[m_Session].BuyLASMReady && (LASMBand<=BuyOpenReadyBand) ) 
     { 
