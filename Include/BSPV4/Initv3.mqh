...
ReOC.LRConBars=m_LRConBars;  
ReOC.DLRBars=m_DLRBars;

//ReOC.BuyLRConLASSBand=m_BuyLRConLASSBand;
ReOC.BuyLRConLASLBand=m_BuyLRConLASLBand;
//ReOC.SellLRConLASSBand=m_SellLRConLASSBand;
ReOC.SellLRConLASLBand=m_SellLRConLASLBand; 

//ReOC.BuyLCLASSBand=m_BuyLCLASSBand;
ReOC.BuyLCLASLBand=m_BuyLCLASLBand;
//ReOC.SellLCLASSBand=m_SellLCLASSBand;
ReOC.SellLCLASLBand=m_SellLCLASLBand;

//ReOC.BuyLCConLASSBand=m_BuyLCConLASSBand;
//ReOC.BuyLCConLASLBand=m_BuyLCConLASLBand;
//ReOC.SellLCConLASSBand=m_SellLCConLASSBand;
//ReOC.SellLCConLASLBand=m_SellLCConLASLBand;
   
//ReOC.BuyDLRLASABand=m_BuyDLRLASABand;
//ReOC.BuyDLRLASLBand=m_BuyDLRLASLBand;
//ReOC.SellDLRLASSBand=m_SellDLRLASSBand;
//ReOC.SellDLRLASLBand=m_SellDLRLASLBand; 

//ReOC.RORBars=m_RORBars;  
ReOC.DLRNoiseTF=m_DLRNoiseTF;
ReOC.NoiseUpMultiFactor=m_NoiseUpMultiFactor;
ReOC.NoiseDownMultiFactor=m_NoiseDownMultiFactor;
