...
int                                 AttachThreadInput(uint attach,uint attach_to,int fattach);
...
int                                 BroadcastSystemMessage(uint flags,uint &info,uint Msg,ulong wparam,ulong lparam);
int                                 BroadcastSystemMessageExW(uint flags,uint &info,uint Msg,ulong wparam,ulong lparam,BSMINFO &bsm_info);
int                                 BroadcastSystemMessageW(uint flags,uint &info,uint Msg,ulong wparam,ulong lparam);
...
PVOID                               CallNextHookEx(HANDLE hhk,int code,ulong wparam,ulong lparam);
PVOID                               CallWindowProcW(PVOID prev_wnd_func,HANDLE wnd,uint Msg,ulong wparam,ulong lparam);
int                                 CancelShutdown(void);
ushort                              CascadeWindows(HANDLE parent,uint how,const RECT &rect,uint kids_count,const HANDLE &kids[]);
...
HANDLE                              CreateCursor(HANDLE inst,int hot_spot_x,int hot_spot_y,int width,int height,PVOID pvANDPlane,PVOID pvXORPlane);
...
HANDLE                              CreateIconFromResourceEx(uchar &presbits,uint res_size,int icon,uint ver,int desired_cx,int desired_cy,uint Flags);
...
PVOID                               DefDlgProcW(HANDLE dlg,uint Msg,ulong wparam,ulong lparam);
HANDLE                              DeferWindowPos(HANDLE win_pos_info,HANDLE wnd,HANDLE wnd_insert_after,int x,int y,int cx,int cy,uint flags);
PVOID                               DefFrameProcW(HANDLE wnd,HANDLE hWndMDIClient,uint msg,ulong wparam,ulong lparam);
PVOID                               DefMDIChildProcW(HANDLE wnd,uint msg,ulong wparam,ulong lparam);
PVOID                               DefRawInputProc(RAWINPUT &raw_input[],int inp,uint size_header);
PVOID                               DefWindowProcW(HANDLE wnd,uint Msg,ulong wparam,ulong lparam);
...
int                                 DrawIconEx(HANDLE hdc,int left,int top,HANDLE icon,int width,int height,uint if_ani_cur,HANDLE flicker_free_draw,uint flags);
int                                 DrawMenuBar(HANDLE wnd);
int                                 DrawStateW(HANDLE hdc,HANDLE fore,PVOID call_back,ulong ldata,ulong wdata,int x,int y,int cx,int cy,uint flags);
int                                 DrawTextExW(HANDLE hdc,string text,int text_len,RECT &lprc,uint format,DRAWTEXTPARAMS &lpdtp);
int                                 DrawTextW(HANDLE hdc,const string text,int text_len,RECT &lprc,uint format);
...
int                                 GetAltTabInfoW(HANDLE hwnd,int item,ALTTABINFO &pati,string item_text,uint item_text_len);
...
int                                 GetGestureExtraArgs(HANDLE gesture_info,uint extra_args_len,uchar &extra_args[]);
int                                 GetGestureInfo(HANDLE gesture,GESTUREINFO &gesture_info);
...
int                                 GetMenuItemRect(HANDLE wnd,HANDLE menu,uint uitem,RECT &item);
...
int                                 GetPointerDevice(HANDLE device,POINTER_DEVICE_INFO &device_info);
...
int                                 GetPointerFrameInfoHistory(uint id,uint &ecount,uint &pcount,POINTER_INFO &info[][]);
int                                 GetPointerFramePenInfo(uint id,uint &count,POINTER_PEN_INFO &info[]);
int                                 GetPointerFramePenInfoHistory(uint id,uint &ecount,uint &pcount,POINTER_PEN_INFO &info[][]);
int                                 GetPointerFrameTouchInfo(uint id,uint &count,POINTER_TOUCH_INFO &info[]);
int                                 GetPointerFrameTouchInfoHistory(uint id,uint &ecount,uint &pcount,POINTER_TOUCH_INFO &info[][]);
...
int                                 GetRawPointerDeviceData(uint id,uint hcount,uint pcount,POINTER_DEVICE_PROPERTY &properties[],int &values[]);
...
int                                 GetTouchInputInfo(HANDLE touch_input,uint inputs_count,TOUCHINPUT &inputs[],int size);
...
int                                 LookupIconIdFromDirectoryEx(uchar &presbits,int icon,int desired_w,int desired_h,uint Flags);
...
int                                 PostMessageW(HANDLE wnd,uint Msg,ulong wparam,ulong lparam);
void                                PostQuitMessage(int exit_code);
int                                 PostThreadMessageW(uint thread,uint Msg,ulong wparam,ulong lparam);
int                                 PrintWindow(HANDLE hwnd,HANDLE blt,uint flags);
uint                                PrivateExtractIconsW(const string file_name,int icon_index,int icon_w,int icon_h,HANDLE &phicon,uint &piconid,uint icons,uint flags);
...
int                                 ScrollDC(HANDLE hDC,int dx,int dy,RECT &scroll,RECT &clip,HANDLE update,RECT &update_rc);
int                                 ScrollWindow(HANDLE wnd,int XAmount,int YAmount,RECT &rect,RECT &clip_rect);
int                                 ScrollWindowEx(HANDLE wnd,int dx,int dy,RECT &scroll,RECT &clip,HANDLE update,RECT &update_rc,uint flags);
PVOID                               SendDlgItemMessageW(HANDLE dlg,int nIDDlgItem,uint Msg,ulong wparam,ulong lparam);
uint                                SendInput(uint inputs_count,INPUT &inputs[],int size);
int                                 SendMessageCallbackW(HANDLE wnd,uint Msg,ulong wparam,ulong lparam,PVOID result_call_back,ulong data);
PVOID                               SendMessageTimeoutW(HANDLE wnd,uint Msg,ulong wparam,ulong lparam,uint flags,uint timeout,PVOID result);
PVOID                               SendMessageW(HANDLE wnd,uint Msg,ulong wparam,ulong lparam);
int                                 SendNotifyMessageW(HANDLE wnd,uint Msg,ulong wparam,ulong lparam);
...
HANDLE                              SetWinEventHook(uint min,uint max,HANDLE win_event,PVOID win_event_proc,uint process,uint thread,uint flags);
...
int                                 ShutdownBlockReasonQuery(HANDLE wnd,string& buff,uint &buff_len);
...
int                                 SystemParametersInfoForDpi(uint action,uint iparam,PVOID vparam,uint win_ini,uint dpi);
int                                 SystemParametersInfoW(uint action,uint uparam,PVOID vparam,uint win_ini);
...
ushort                              TileWindows(HANDLE parent,uint how,const RECT &rect,uint kids_count,const HANDLE &kids[]);
...
int                                 UpdateLayeredWindow(HANDLE wnd,HANDLE dst,POINT &dst_pt,SIZE &psize,HANDLE src,POINT &src_pt,uint key,BLENDFUNCTION &pblend,uint flags);
