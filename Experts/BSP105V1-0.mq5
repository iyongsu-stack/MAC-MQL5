...
//LRAvg
input int                 StdAvgLwmaPeriod     = 15;          // StdAvgWmaPeriod1
input int                 StdAvgLRPeriod       = 5;           // StdAvgLRPeriod
input int                 StdAvgStdPeriodL     = 10000;        // StdAvgStdPeriodL
input int                 StdAvgPeriodS        = 5;           //StdAvg1AvgPeriod
input int                 StdAvgPeriodL        = 20;           //StdAvg2AvgPeriod
input double              StdAvgMultiFactorL1  = 2.0;         // StdAvgStdMultiFactorL1
input double              StdAvgMultiFactorL2  = 4.0;         // StdAvgStdMultiFactorL2
input double              StdAvgMultiFactorL3  = 7.0;         // StdAvgStdMultiFactorL3
//Wma
input int                 WmaPeriodS           = 6;          // wmaPeriodS
input int                 WmaPeriodL           = 12;          // wmaPeriodS
...
int OnInit(){
   ...
   LRStdAvgHandleS   = iCustom(_Symbol,PERIOD_M1,IND2, StdAvgLwmaPeriod, StdAvgLRPeriod, StdAvgStdPeriodL, StdAvgPeriodS, 
                                                       StdAvgMultiFactorL1, StdAvgMultiFactorL2, StdAvgMultiFactorL3);
   LRStdAvgHandleL   = iCustom(_Symbol,PERIOD_M1,IND2, StdAvgLwmaPeriod, StdAvgLRPeriod, StdAvgStdPeriodL, StdAvgPeriodL,
                                                       StdAvgMultiFactorL1, StdAvgMultiFactorL2, StdAvgMultiFactorL3);
...
bool Indicators(){
   ...
   if( StartTrading ) OpenReadyCheck();
   
   if( (BuyPositionInfo.numberOfPositions >= 1) || ( SellPositionInfo.numberOfPositions >= 1) ) CloseReadyCheck();
...
bool SignalOpenSell()
  {
   ...
   if( SellOpenReady.ShortWmaReady)
     {
      return(true);
     }   
