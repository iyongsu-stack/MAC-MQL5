...
input int                  inpPeriod0          = 10;          // ShortTrend Period
input int                  inpPeriod1          = 10;          // MediumTrend Period
input int                  inpPeriod2          = 500;          // LongTrend Period
...
int OnInit(){
   ...
   Handle=iCustom(_Symbol,_Period,IND1, inpPeriod0, inpPeriod1, inpPeriod2, inpPrice);
