...
input int                 LwmaPeriodL    = 20;          // WmaPeriodL
...
input int                 LwmaPeriodS    = 10;          // WmaPeriodS
...
input double              BSPMultiFactorL1  = 0.8;         // BSPStdMultiFactorL1
input double              BSPMultiFactorL2  = 1.5;         // BSPStdMultiFactorL2
