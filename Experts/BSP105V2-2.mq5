...
// Same Direction Sell Check       
      ...
      else if( BuyOpenReady.ASReady && (SellOpenReady.ASRStatus == Original) && (ASTrend == UpTrend) && (ShortWmaTrend == UpTrend) &&
      ...
      else if( BuyOpenReady.ASReady && (SellOpenReady.ASRStatus == Back) && (ShortWmaTrend == DownTrend) &&
               (ASBand == BandM1 || ASBand == BandM2 || ASBand == BandM3))
        {
...
// Same Direction Buy Check
      ...
      else if( SellOpenReady.ASReady && (BuyOpenReady.ASRStatus == Original) && (ASTrend == DownTrend) && (ShortWmaTrend == DownTrend) &&
      ...
      else if( SellOpenReady.ASReady && (BuyOpenReady.ASRStatus == Back) && (ShortWmaTrend == UpTrend) &&
                (ASBand == BandP1 || ASBand == BandP2 || ASBand == BandP3))
        {
