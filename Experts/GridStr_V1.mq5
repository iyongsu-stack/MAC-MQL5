...
void OnTick()
{
   ...
   if(UseDailyTimer == true) MyTimerOn = DailyTimerOn;
	...
	{
//      datetime testTime2 = TimeCurrent();
		GetPositionTickets(); 
...
int CheckCrossGrid()
{
   ...
   if(currPrice > UpGrid) return(UpCross);
   else if(currPrice < DnGrid) return(DnCross);
